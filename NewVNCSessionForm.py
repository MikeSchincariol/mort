...
class NewVNCSessionForm(object):
    ...
    def __init__(self):
        ...
        self.display_number_label.grid(column=0, row=0, padx=5, pady=5, sticky=(N, S, E, W))
        self.display_number = StringVar()
        self.display_number_entry = ttk.Entry(self.toplevel, textvariable=self.display_number, width=4)
        self.display_number_entry.grid(column=1, row=0, padx=5, pady=5, sticky=(N, S, E, W))

        # The display name label and entry box
        self.display_name_label = ttk.Label(self.toplevel, text="Display Name")
        self.display_name_label.grid(column=0, row=1, padx=5, pady=5, sticky=(N, S, E, W))
        self.display_name = StringVar()
        self.display_name_entry = ttk.Entry(self.toplevel, textvariable=self.display_name, width=4)
        self.display_name_entry.grid(column=1, columnspan=2, row=1, padx=5, pady=5, sticky=(N, S, E, W))

        # The session geometry label and boxes for width and height.
        self.width_label = ttk.Label(self.toplevel, text="W", width=4)
        self.width_label.grid(column=1, row=2, padx=5, pady=5, sticky=(N, S, E, W))
        self.height_label = ttk.Label(self.toplevel, text="H", width=4)
        self.height_label.grid(column=2, row=2, padx=5, pady=5, sticky=(N, S, E, W))
        self.geometry_label = ttk.Label(self.toplevel, text="Geometry")
        self.geometry_label.grid(column=0, row=3, padx=5, pady=5, sticky=(N, S, E, W))
        self.width = StringVar()
        self.width_entry = ttk.Entry(self.toplevel, textvariable=self.width, width=4)
        self.width_entry.grid(column=1, row=3, padx=5, pady=5, sticky=(N, S, E, W))
        self.height = StringVar()

        self.height_entry = ttk.Entry(self.toplevel, textvariable=self.height, width=4)
        self.height_entry.grid(column=2, row=3, padx=5, pady=5, sticky=(N, S, E, W))

        self.pxielformat_label = ttk.Label(self.toplevel, text="Pixelformat")
        self.pxielformat_label.grid(column=0, row=4, padx=5, pady=5, sticky=(E, W))
        ...
        self.pixelformat_combobox = ttk.Combobox(self.toplevel,
                                                 ...
                                                 width=8)
        self.pixelformat_combobox.grid(column=1, row=4, padx=5, pady=5, sticky=(N, S, E, W))

        # Create a lableframe to visually offset the buttons from the rest of the form

        self.frame = ttk.Frame(self.toplevel)
        self.frame.grid(column=1, columnspan=2, row=5, padx=5, pady=5, sticky=(N, S, E, W))

        self.ok_button = ttk.Button(self.frame,
                                    text="OK",
                                    command=self._on_ok_clicked)
        self.ok_button.grid(column=0, row=0, padx=5, pady=5, sticky=(N, S, E, W))

        self.cancel_button = ttk.Button(self.frame,
                                        text="Cancel",
                                        command=self._on_cancel_clicked)
        self.cancel_button.grid(column=1, row=0, padx=5, pady=5, sticky=(N, S, E, W))
